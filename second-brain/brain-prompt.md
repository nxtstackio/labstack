...
Set up shared Obsidian project memory for my coding project using the procedure and embedded templates below. Start with the guided intake below: ask what I need, wait for my answers, then handle the setup for me. No skill installation or access to Labstack is needed.
